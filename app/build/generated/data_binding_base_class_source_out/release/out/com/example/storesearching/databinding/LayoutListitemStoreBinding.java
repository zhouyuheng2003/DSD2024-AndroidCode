...
public final class LayoutListitemStoreBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutListitemStoreBinding(@NonNull LinearLayout rootView, @NonNull Button button,
  ...
  @NonNull
  public static LayoutListitemStoreBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutListitemStoreBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_listitem_store, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutListitemStoreBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutListitemStoreBinding((LinearLayout) rootView, button, textViewDes,
