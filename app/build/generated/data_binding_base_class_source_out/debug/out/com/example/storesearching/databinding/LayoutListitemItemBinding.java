...
public final class LayoutListitemItemBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static LayoutListitemItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutListitemItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_listitem_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutListitemItemBinding bind(@NonNull View rootView) {
